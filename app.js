...
const features = {
  demo: { number: '01', title: 'See DreamScaler in action.', description: 'Watch a demo of the standalone app and see how DreamScaler brings music to life.', points: ['The standalone app in action', 'Music, made visible', 'Watch the demo on YouTube'], video: 'https://www.youtube-nocookie.com/embed/ci7FN7KSW7A' },
