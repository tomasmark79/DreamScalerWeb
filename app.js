...
const features = {
  ...
  bitwig: { number: '07', title: 'See what your DAW is playing.', description: 'See playing notes on your LED strip and sync root and scale with Bitwig 6. A video walkthrough is in preparation.', points: ['Two-way root and scale sync', 'Simple Project Remotes setup', '21 mapped scales'], image: 'dreamscaler-bitwig-extension.png', alt: 'DreamScaler Bitwig extension with root and scale synchronization controls', caption: 'Video walkthrough in preparation' },
