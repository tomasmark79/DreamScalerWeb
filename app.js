...
const features = {
  demo: { number: '01', title: 'See DreamScaler in action.', description: 'From connecting the LED strip to exploring your first scale. Watch the full setup and walkthrough of the standalone app.', points: ['Connect and align the strip', 'Explore scales and chord progressions', 'Choose colours and brightness'], video: 'https://www.youtube-nocookie.com/embed/ci7FN7KSW7A' },
  ...
  bitwig: { number: '07', title: 'See what your DAW is playing.', description: 'See playing notes on your LED strip and sync root and scale with Bitwig 6. Watch the video walkthrough of the Bitwig extension.', points: ['Two-way root and scale sync', 'Simple Project Remotes setup', '21 mapped scales'], video: 'https://www.youtube-nocookie.com/embed/EgOmQQo_Pl0', videoTitle: 'DreamScaler Bitwig extension walkthrough', caption: 'Watch the Bitwig extension walkthrough' },
