...
const features = {
  ...
  bitwig: { number: '07', title: 'See what your DAW is playing.', description: 'Choose a root and scale in DreamScaler and send them to Bitwig Studio’s global key through Project Remote Controls. See your scale and playing MIDI notes light up on the keyboard.', points: ['New: global root and scale control in Bitwig 6', 'Independent switches for root and scale sync', '21 DreamScaler scales mapped to Bitwig'], video: 'https://www.youtube-nocookie.com/embed/cD8VHF40KNY', videoTitle: 'DreamScaler Bitwig extension demo', caption: 'A look inside the Bitwig extension' },
